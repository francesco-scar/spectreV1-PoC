...
init_idt:
	...
	carica_gate	TIPO_VULN	a_victim_function	LIV_UTENTE
	carica_gate	TIPO_GET_DIFF	a_get_malicious_x	LIV_UTENTE
	carica_gate	TIPO_ARRAY_ACCESS	a_array_access_function	LIV_UTENTE
	carica_gate TIPO_FLUSH_UTIL		a_flush_util	LIV_UTENTE
	carica_gate TIPO_TEST_PERFORMANCE		c_test_performance	LIV_UTENTE
...
// mitigazione                                        //
////////////////////////////////////////////////////////
	.global array_index_mask_nospec
...
a_get_malicious_x:
	...
	.cfi_offset rsp, -16
	call salva_stato
		call c_get_malicious_x
	call carica_stato
	iretq
	.cfi_endproc
	
		.extern c_array_access_function
a_array_access_function:
	.cfi_startproc
	.cfi_def_cfa_offset 40
	.cfi_offset rip, -40
	.cfi_offset rsp, -16
	call salva_stato
		call c_array_access_function
	call carica_stato
	iretq
	.cfi_endproc

		.extern c_victim_function
a_victim_function:
	.cfi_startproc
	.cfi_def_cfa_offset 40
	.cfi_offset rip, -40
