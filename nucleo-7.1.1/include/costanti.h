...
#define TIPO_VULN       0x28    ///< vulnerable function
#define TIPO_GET_DIFF   0x29    ///< get correct offset from secret
#define TIPO_ARRAY_ACCESS 0x2A  ///< accedi ad array2
#define TIPO_FLUSH_UTIL 0x2B    ///< funzione di utilità
#define TIPO_TEST_PERFORMANCE 0x2C     ///< test delle performance
/// @}
