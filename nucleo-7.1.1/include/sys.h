...
extern "C" void victim_function(size_t x);
extern "C" void flush_util(bool type);
extern "C" void test_performance();
extern "C" size_t get_malicious_x ();
extern "C" uint64_t array_access_function(int x);
extern "C" void sys_readMemoryByte(int cache_hit_threshold, size_t malicious_x, uint8_t value[2], int score[2]);
